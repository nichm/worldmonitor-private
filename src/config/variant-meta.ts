...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  toronto: {
    title: 'Toronto Monitor - Real-Time Toronto & GTA City Intelligence Dashboard',
    description: 'Real-time Toronto and Greater Toronto Area intelligence dashboard tracking emergencies, infrastructure, development, transit, shelters, weather alerts, housing, and city services.',
    keywords: 'Toronto dashboard, GTA intelligence, city monitor, Toronto Fire CAD, Ontario 511, weather alerts, Environment Canada, shelter system, Bank of Canada, building permits, DineSafe, TRCA floods, housing targets, TTC health, city services, emergency monitoring, municipal data',
    url: 'https://toronto.worldmonitor.app/',
    siteName: 'Toronto Monitor',
    shortName: 'TorontoMonitor',
    subject: 'Toronto & GTA City Intelligence and Emergency Monitoring',
    classification: 'City Dashboard, Municipal Intelligence, Emergency Monitor',
    categories: ['news', 'productivity'],
    features: [
      'Toronto Fire CAD tracking',
      'Ontario 511 highway incidents',
      'Environment Canada weather alerts',
      'Shelter system monitoring',
      'Bank of Canada rates',
      'Building permit tracking',
      'DineSafe restaurant closures',
      'TRCA flood status',
      'Housing targets progress',
      'TTC health monitoring',
    ],
  },
};
