...
> = {
  ...
  torontoCivic: {
    ...
    panelKeys: ["dinesafe", "toronto-crime", "parks-recreation", "schools", "court-facilities", "ev-charging", "cycling-network", "ravine-protection", "tree-canopy", "lake-ontario-level", "bike-share", "urban-heat", "crime-incidents", "eccc-aqhi", "childcare", "flu-clinics", "agco-licences", "green-roof-permits", "library-branches", "election-data", "federal-ridings", "mls-investigations", "toronto-hydro", "traffic-signals"],
    variants: ["toronto"],
  },
};
