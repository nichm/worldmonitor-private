...
export const TORONTO_FEEDS: Record<string, Feed[]> = {
  canadianNews: [
    { name: 'CBC News', url: rss('https://rss.cbc.ca/lineup/canada.xml'), tier: 1, region: 'CA' },
    { name: 'CBC Toronto', url: rss('https://rss.cbc.ca/cmlink/rss-canada-toronto'), tier: 1, region: 'CA' },
    { name: 'CTV News', url: rss('https://www.ctvnews.ca/rss/ctvnews-ca-top-stories-public-rss-1.822009'), tier: 1, region: 'CA' },
    { name: 'Global News', url: rss('https://globalnews.ca/feed/'), tier: 1, region: 'CA' },
  ],
  torontoNews: [
    { name: 'CityNews Toronto', url: rss('https://toronto.citynews.ca/feed'), tier: 2, region: 'CA' },
    { name: 'Ontario News', url: rss('https://news.ontario.ca/en/rss/newsreleases'), tier: 2, region: 'CA' },
  ],
  financial: [
    { name: 'Bank of Canada', url: rss('https://www.bankofcanada.ca/news/press-releases/rss/'), tier: 2, region: 'CA' },
  ],
  environment: [
    { name: 'TRCA', url: rss('https://trca.ca/feed/'), tier: 3, region: 'CA' },
    { name: 'Environment Canada Weather Alerts', url: '/api/eccc-ontario-alerts', tier: 1, region: 'CA', type: 'eccc-alerts' },
  ],
};
...
export const DEFAULT_PANELS: Record<string, PanelConfig> = {
  ...
  'toronto-development': { name: 'Development Pipeline', enabled: true, priority: 1 },
  'ontario-electricity': { name: 'Electricity Price', enabled: true, priority: 1 },
...
export const VARIANT_CONFIG: VariantConfig = {
  name: 'toronto',
  description: 'Toronto & GTA city intelligence — emergency, development, social, transit',
...
export const ADDITIONAL_FEEDS: Feed[] = [
  { name: 'CBC Canada News', url: rss('https://rss.cbc.ca/lineup/canada.xml'), tier: 1, region: 'CA' },
  { name: 'CBC Toronto News', url: rss('https://rss.cbc.ca/cmlink/rss-canada-toronto'), tier: 1, region: 'CA' },
  { name: 'CTV Canada News', url: rss('https://www.ctvnews.ca/rss/ctvnews-ca-top-stories-public-rss-1.822009'), tier: 1, region: 'CA' },
  { name: 'Global News Canada', url: rss('https://globalnews.ca/feed/'), tier: 1, region: 'CA' },
  { name: 'Toronto CityNews', url: rss('https://toronto.citynews.ca/feed'), tier: 2, region: 'CA' },
  { name: 'Ontario Newsroom', url: rss('https://news.ontario.ca/en/rss/newsreleases'), tier: 2, region: 'CA' },
  { name: 'Bank of Canada Press Releases', url: rss('https://www.bankofcanada.ca/news/press-releases/rss/'), tier: 2, region: 'CA' },
  { name: 'TRCA Updates', url: rss('https://trca.ca/feed/'), tier: 3, region: 'CA' },
  { name: 'Environment Canada Weather Alerts', url: '/api/eccc-ontario-alerts', tier: 1, region: 'CA', type: 'eccc-alerts' },
];
