...
export const FEEDS: Record<string, Feed[]> = {
  ...
  startups: [
    ...
    { name: "SaaStr", url: rss("https://www.saastr.com/feed/") },
    {
      ...
      url: rss("https://techcrunch.com/category/venture/feed/"),
    },
    {
    ...
    {
      name: "CB Insights",
      url: rss("https://www.cbinsights.com/research/feed/"),
    },
  ],
  ...
  vcblogs: [
    {
      ...
      url: rss("https://www.ycombinator.com/blog/rss/"),
    },
    { name: "a16z Blog", url: rss("https://www.a16z.news/feed") },
    {
      name: "First Round Review",
      url: rss("https://review.firstround.com/articles/rss"),
    },
    { name: "Sequoia Blog", url: rss("https://www.sequoiacap.com/feed/") },
    { name: "NFX Essays", url: rss("https://www.nfx.com/feed") },
    {
      name: "Paul Graham Essays",
      url: rss("https://www.aaronsw.com/2002/feeds/pgessays.rss"),
    },
    {
      name: "Both Sides of Table",
      url: rss("https://bothsidesofthetable.com/feed"),
    },
    {
      name: "Lenny's Newsletter",
      url: rss("https://www.lennysnewsletter.com/feed"),
    },
  ...
  security: [
    ...
    },
    {
      ...
      url: rss("https://www.ransomware.live/rss.xml"),
    },
  ],
  ...
  policy: [
    {
      name: "Politico Tech",
      url: rss("https://rss.politico.com/technology.xml"),
    },
    {
      name: "AI Regulation",
      url: rss(
  ...
  finance: [
    {
      name: "CNBC Tech",
      url: rss("https://www.cnbc.com/id/19854910/device/rss/rss.html"),
    },
    {
    ...
    {
      name: "Yahoo Finance",
      url: rss("https://finance.yahoo.com/rss/topstories"),
    },
    {
      name: "Seeking Alpha Tech",
      url: rss("https://seekingalpha.com/market_currents.xml"),
    },
  ],
  ...
  hardware: [
    {
      name: "Tom's Hardware",
      url: rss("https://www.tomshardware.com/feeds/all"),
    },
  ...
  layoffs: [
    ...
    },
    {
      ...
      url: rss("https://techcrunch.com/tag/layoffs/feed/"),
    },
  ],
  ...
  accelerators: [
    ...
    {
      name: "Techstars Blog",
      url: rss("https://www.techstars.com/blog/feed/"),
    },
    {
